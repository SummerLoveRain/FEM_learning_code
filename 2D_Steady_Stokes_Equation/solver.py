...
class Steady_Stokes_2D_FE_solver_Dirichlet(Base_2D_Solver):
    def __init__(self, bounds, Nx, Ny, nu, u_basis_function_type, p_basis_function_type, source1_function, source2_function, Gaussian_Integral_triangular_2D_N=10):
        ...
        '''
        super(Steady_Stokes_2D_FE_solver_Dirichlet, self).__init__(bounds, Nx, Ny, nu, u_basis_function_type, p_basis_function_type, Gaussian_Integral_triangular_2D_N)
