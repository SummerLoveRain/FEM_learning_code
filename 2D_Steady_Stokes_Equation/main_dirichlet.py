import numpy as np
from fem import *
from solver import Steady_Stokes_2D_FE_solver_Dirichlet
...
if __name__ == '__main__':
    ...
    for i in range(5):
        ...
        Ny = 2*(2**i)
        nu = 2
        solver = Steady_Stokes_2D_FE_solver_Dirichlet(bounds, Nx, Ny, nu=nu, source1_function=source1_function, source2_function=source2_function, \
