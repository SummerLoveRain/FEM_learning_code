...
class Elasticity_2D_FE_solver_Dirichlet(Base_2D_Solver):
    ...
    def solve(self):
        ...
        A1 = integrate_trial_test_basis_function_2D(P, T, Pb, Tb, Pb, Tb, coefficient_function=lambda x, y: self.lambda_, \
        ...
        A2 = integrate_trial_test_basis_function_2D(P, T, Pb, Tb, Pb, Tb, coefficient_function=lambda x, y: self.mu, \
                        trial_basis_function=self.basis_function, test_basis_function=self.basis_function, \
                        trial_derivative_order=[1, 0], test_derivative_order=[1, 0], \
                        Gaussian_Integral_triangular_2D_N=self.Gaussian_Integral_triangular_2D_N)
        A3 = integrate_trial_test_basis_function_2D(P, T, Pb, Tb, Pb, Tb, coefficient_function=lambda x, y: self.mu, \
                        trial_basis_function=self.basis_function, test_basis_function=self.basis_function, \
                        trial_derivative_order=[0, 1], test_derivative_order=[0, 1], \
                        Gaussian_Integral_triangular_2D_N=self.Gaussian_Integral_triangular_2D_N)
        A4 = integrate_trial_test_basis_function_2D(P, T, Pb, Tb, Pb, Tb, coefficient_function=lambda x, y: self.lambda_, \
                        trial_basis_function=self.basis_function, test_basis_function=self.basis_function, \
                        trial_derivative_order=[0, 1], test_derivative_order=[1, 0], \
                        Gaussian_Integral_triangular_2D_N=self.Gaussian_Integral_triangular_2D_N)
        A5 = integrate_trial_test_basis_function_2D(P, T, Pb, Tb, Pb, Tb, coefficient_function=lambda x, y: self.mu, \
                        trial_basis_function=self.basis_function, test_basis_function=self.basis_function, \
                        trial_derivative_order=[1, 0], test_derivative_order=[0, 1], \
                        Gaussian_Integral_triangular_2D_N=self.Gaussian_Integral_triangular_2D_N)
        A6 = integrate_trial_test_basis_function_2D(P, T, Pb, Tb, Pb, Tb, coefficient_function=lambda x, y: self.lambda_, \
                        trial_basis_function=self.basis_function, test_basis_function=self.basis_function, \
                        trial_derivative_order=[1, 0], test_derivative_order=[0, 1], \
                        Gaussian_Integral_triangular_2D_N=self.Gaussian_Integral_triangular_2D_N)
        A7 = integrate_trial_test_basis_function_2D(P, T, Pb, Tb, Pb, Tb, coefficient_function=lambda x, y: self.mu, \
                        trial_basis_function=self.basis_function, test_basis_function=self.basis_function, \
                        trial_derivative_order=[0, 1], test_derivative_order=[1, 0], \
                        Gaussian_Integral_triangular_2D_N=self.Gaussian_Integral_triangular_2D_N)
        A8 = integrate_trial_test_basis_function_2D(P, T, Pb, Tb, Pb, Tb, coefficient_function=lambda x, y: self.lambda_, \
                        trial_basis_function=self.basis_function, test_basis_function=self.basis_function, \
                        trial_derivative_order=[0, 1], test_derivative_order=[0, 1], \
                        Gaussian_Integral_triangular_2D_N=self.Gaussian_Integral_triangular_2D_N)
        A11 = A1 + 2*A2 + A3        
