...
def Gaussian_Integral_triangular_2D(vertices, f, n):
    ...
    if n==1:
        nodes = np.array([[1/3, 1/3]],dtype=np.float64)
        weights = np.array([1.0],dtype=np.float64)
    elif n==3:
        nodes = np.array([[0.5, 0.5], [0.5, 0], [0, 0.5]],dtype=np.float64)
        weights = np.array([1/3, 1/3, 1/3],dtype=np.float64)
    elif n==4:
        nodes = np.array([[1/3, 1/3], [3/5, 1/5], [1/5, 1/5], [1/5, 3/5]],dtype=np.float64)
        weights = np.array([-27/48, 25/48, 25/48, 25/48],dtype=np.float64)
    elif n==6:
        nodes = np.array([[0.816847572980459, 0.091576213509771], [0.091576213509771, 0.816847572980459], [0.091576213509771, 0.091576213509771], [0.108103018168070, 0.445948490915965], [0.445948490915965, 0.108103018168070], [0.445948490915965, 0.445948490915965]],dtype=np.float64)
        weights = np.array([0.109951743655322*0.5, 0.109951743655322*0.5, 0.109951743655322*0.5, 0.223381589678011*0.5, 0.223381589678011*0.5, 0.223381589678011*0.5],dtype=np.float64)
    elif n==12:
        nodes = np.array([[0.873821971016996,0.063089014491502], [0.063089014491502,0.873821971016996], [0.063089014491502,0.063089014491502], [0.501426509658179,0.249286745170910], [0.249286745170910,0.501426509658179], [0.501426509658179,0.501426509658179], [0.636502499121399,0.310352451033785], [0.636502499121399,0.053145049844816], [0.310352451033785,0.636502499121399], [0.310352451033785,0.053145049844816], [0.053145049844816,0.636502499121399], [0.053145049844816,0.310352451033785]],dtype=np.float64)
        weights = np.array([0.050844906370207*0.5, 0.050844906370207*0.5, 0.050844906370207*0.5, 0.116786275726379*0.5, 0.116786275726379*0.5, 0.116786275726379*0.5, 0.082851075618374*0.5, 0.082851075618374*0.5, 0.082851075618374*0.5, 0.082851075618374*0.5, 0.082851075618374*0.5, 0.082851075618374*0.5],dtype=np.float64)
    else:
        ValueError("The number of n=%d exceeds the limit!" % n)
    integral = np.sum(weights * f(*shift_xy(nodes))) * J
    # integral = np.sum(weights * f(*shift_xy(nodes))) * (Jx1*Jy2+Jx2*Jy1)*J**2
    return integral
