...
if __name__ == '__main__':
    ...
    for i in range(5):
        ...
        Nx = 8*(2**i)
        Ny = 8*(2**i)
        solver = Possion_2D_FE_solver_Dirichlet(bounds, Nx, Ny, coefficient_function=coefficient_function, source_function=source_function, basis_function_type=Basis.LINEAR)
        # solver.generate_P_T()
